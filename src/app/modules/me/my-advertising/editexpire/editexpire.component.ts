...
// }
  ...
  show(event:any){
    ...
    this.storessserve.product_data=this.data
     //if(value.slice(value.indexOf('+')+1)=='true'){
       this.route.navigateByUrl(`/me/profile/my-profile/select-category/${JSON.stringify(this.data)}`)
 ...
 this.data.update=id
 this.storessserve.product_data=this.data
 //this.route.navigateByUrl(`/me/profile/my-profile/select-category/${(JSON.stringify(this.data)).replace('#','*')}`)
 this.route.navigateByUrl(`/me/profile/my-profile/edit-properities`)
   ...
   changepro(){
    this.data.edit=this.active.snapshot.params['id']
     ...
     this.storessserve.product_data=this.data
     this.route.navigateByUrl(`/me/my-advertising/edit-properities`)

    // this.route.navigateByUrl(`/me/my-advertising/select-category/${(JSON.stringify(this.data)).replace('#','*')}`)

   }
   navme(){
     this.storessserve.product_data=this.data
     this.route.navigateByUrl(`/me/my-advertising/edit-color_size`)
  ...
  this.mydata=this.data
    this.storessserve.product_data=this.data
  this.route.navigateByUrl(`/me/my-advertising/cities/data`)
   }
...
upgrade(){
  this.route.navigateByUrl(`/me/my-advertising/expired-ads`)
}
toggleonline(){
